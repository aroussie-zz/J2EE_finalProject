...
@ManagedBean
@RequestScoped
public class PlymouthController {

    private static final Logger LOG = Logger.getLogger(PlymouthController.class.getName());
     ...
     * Default constructor
     */
    public PlymouthController() {
    }

    @PostConstruct
    public void setUp() {
        facesContext = FacesContext.getCurrentInstance();
        plymouth = cityService.findCityByName("Plymouth");
        listTopics = plymouth.getTopics();
        listPosts = plymouth.getPosts();
        topic = new Topics();
        post = new Post();
    ...
    /**
     * Refresh the list of Topics and Posts for the page Plymouth
     */
    public void refresh() {
        plymouth = cityService.findCityByName("Plymouth");
        listTopics = plymouth.getTopics();
    ...
    public String createTopic() {
        ...
        topicService.createTopic(this.topic, this.plymouth, this.student);
        LOG.info("Topic created !");
        refresh();
        return ("/app/public/plymouth/index.xhtml");
    }
    ...
    public City getPlymouth() {
        return plymouth;
    }

    public void setPlymouth(City plymouth) {
        this.plymouth = plymouth;
    }
