...
@ManagedBean
@RequestScoped
public class SherbrookeController {

    private static final Logger LOG = Logger.getLogger(SherbrookeController.class.getName());
     ...
     * Default constructor
     */
    public SherbrookeController() {
    }

    @PostConstruct
    public void setUp() {
        facesContext = FacesContext.getCurrentInstance();
        sherbrooke = cityService.findCityByName("Sherbrooke");
        listTopics = sherbrooke.getTopics();
        listPosts = sherbrooke.getPosts();
        topic = new Topics();
        post = new Post();
    ...
    /**
     * Refresh the list of Topics and Posts for the page Sherbrooke
     */
    public void refresh() {
        sherbrooke = cityService.findCityByName("Sherbrooke");
        listTopics = sherbrooke.getTopics();
    ...
    public String createTopic() {
        ...
        topicService.createTopic(this.topic, this.sherbrooke, this.student);
        LOG.info("Topic created !");
        refresh();
        return ("/app/public/sherbrooke/index.xhtml");
    }
    ...
    public City getSherbrooke() {
        return sherbrooke;
    }

    public void setSherbrooke(City sherbrooke) {
        this.sherbrooke = sherbrooke;
    }
